function likeVideo(button, videoId){
    ...
    .done(function(data){
        ...
        var likeButton = $(button); // Button is place in jquery parenthisis so we can use jquery functions on the variable
...
function dislikeVideo(button, videoId){
    ...
    .done(function(data){
        ...
        var dislikeButton = $(button); // Button is place in jquery parenthisis so we can use jquery functions on the variable
